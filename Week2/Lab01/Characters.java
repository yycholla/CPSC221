public abstract class Characters {
    ...
    // Boolean variables for the character's abilities. These are not set in the constructor as Java sets them to false by default.
    ...
    private void generateCliche() {
        ...
        }  if (!this.hasManeuvers && !this.tendsToRage && !this.sneaksAround && !this.picksLock && !this.castsSpell && !this.healsOthers && !this.solvesProblems) {
     ...
     * If set is false, then the character is not considered capable of picking locks.
     *
 ...
 * If set is false, then the character is not considered capable of healing others.
 *
